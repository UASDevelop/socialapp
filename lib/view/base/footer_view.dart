                  ...
                  Expanded(flex: 4,
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                          Text('Gharkanna Daily Needs', style: poppinsBold.copyWith(color: ColorResources.getFooterTextColor(context),fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE)),

                          const SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                          Text('Add: Lalbazar, Dipogora, Bankura - 722101', style: poppinsRegular.copyWith(color: ColorResources.getFooterTextColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                          Text('Mailto: info@gharkanna.com', style: poppinsRegular.copyWith(color: ColorResources.getFooterTextColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                          Text('Con: 9679608207', style: poppinsRegular.copyWith(color: ColorResources.getFooterTextColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                      ...
                      TextHover(
                          builder: (hovered) {
                            return InkWell(
                                ...
                                child:Text('Refund Policy & Term', style: hovered? poppinsMedium.copyWith(color: Theme.of(context).primaryColor) : poppinsRegular.copyWith(color: ColorResources.getFooterTextColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)));
                          }
                      ),
                      const SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                      TextHover(
