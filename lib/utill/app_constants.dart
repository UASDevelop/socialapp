...
class AppConstants {
  static const String APP_NAME = 'Gharkanna';
  static const double APP_VERSION = 1.2;
  static const String BASE_URL = 'https://gharkanna.com/admin';
  ...
  static const String TOPIC = 'Gharkanna';
  ...
  static List<LanguageModel> languages = [
    ...
    // SharedLanguageModel(imageUrl: Images.arabic_flag, languageName: 'Arabic', countryCode: 'SA', languageCode: 'ar'),
  ];
}
